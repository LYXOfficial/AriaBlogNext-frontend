...
const genanno=cache(async ()=>{return await new Promise((resolve,reject)=>$.ajax({
    type: 'get',
    ...
    success: function (res) {
        ...
        let dist;
        try{
            dist = getDistance(107.38779, 29.70239, ipLocation.result.location.lng, ipLocation.result.location.lat);
        }catch(e){return;}
