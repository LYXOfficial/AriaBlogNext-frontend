...
export class MarkedCustomTags{
    static a({href,title,tokens}:Tokens.Link){
        return `<a class="normal-a" href="${href}" target="_blank" rel="noopener noreferrer">${(tokens[0] as any).text}</a>`;
    }
