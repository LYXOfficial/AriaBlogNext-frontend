...
export default function ArchiveItem({post,type}:{post:Post,type:"archives"|"categories"|"tags"}){
  return (
    <Link key={post.slug} href={`/posts/${post.slug}`} className="archive-item" title={post.title+"\n"+(post.description??"")}>
      ...
      <object>
        ...
        >
          <Icon icon={`fa6-solid:${type=="categories"?"tags":"list-ul"}`}/>
