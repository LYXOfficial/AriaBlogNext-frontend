...
const bbClickHandle = (event: any) => {
  var str = (event.currentTarget as any).parentNode.parentNode.querySelector(
    ".bb-content",
  ).innerText;
  ...
  ((e as any).value = "> " + str + "\n\n"), e.dispatchEvent(t);
  (document.getElementsByClassName("el-textarea__inner")[0] as any).value =
    "> " + str + "\n\n";
  document.location.href += "#twikoo";
  (
    document.querySelector(".tk-col>.tk-input>.el-textarea__inner") as any
  ).focus();
  Snackbar.show({
