...
const calcProgress = () => {
    const postContent = document.querySelector<HTMLElement>('#post-maincontent:not(#article-container.page #post-maincontent)');
        ...
        const handleScroll = () => {
            ...
            if (currentTocLink) {
                ...
                while (currentTopToc && currentTopToc.parentNode) {
                    ...
                    if (currentTopToc.parentNode && (currentTopToc.parentNode as HTMLElement).className === "toc-content") break;
                }
